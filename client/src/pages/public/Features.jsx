...
const Features = () => {
  ...
  return (
    <>
      ...
      {/* Hero Banner */}
      <section className="relative py-16 md:py-24 overflow-hidden border-b border-slate-200/50 dark:border-slate-900/50">
        <div className="absolute top-[20%] right-1/4 -z-10 h-[400px] w-[400px] rounded-full bg-indigo-500/5 blur-[120px]" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {coreFeatures.map((item, idx) => {
              ...
              return (
                <div 
                  key={idx} 
                  className="border border-slate-200/50 bg-white/40 dark:border-slate-850 dark:bg-slate-900/40 p-6 md:p-8 rounded-3xl shadow-sm hover:border-primary-500/30 hover:translate-y-[-2px] transition-all duration-300 flex flex-col justify-between"
                >
      ...
      <section className="py-16 md:py-20 border-t border-slate-100 dark:border-slate-900 bg-slate-50/20 dark:bg-slate-950/20">
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            
            {/* OCR Illustration Mockup */}
            <div className="border border-slate-200 dark:border-slate-800 rounded-3xl p-6 bg-white dark:bg-slate-900 shadow-xl space-y-6">
      ...
      <section className="py-16 md:py-24">
        <div className="mx-auto max-w-5xl px-4 md:px-8">
          <div className="rounded-3xl bg-gradient-to-tr from-slate-900 to-indigo-950 p-8 md:p-12 text-center text-white border border-slate-800">
