        ...
        <form className="mt-8 space-y-4" onSubmit={handleSubmit(onSubmit)}>
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative rounded-xl shadow-sm">
                ...
                <input
                  ...
                  className={`block w-full rounded-xl border bg-slate-950/60 py-3 pl-11 pr-4 text-sm text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-transparent transition-all duration-200 ${
                    errors.name ? 'border-red-500 focus:ring-red-500/50' : 'border-slate-800'
                  }`}
              ...
              {errors.name && (
                <p className="text-[11px] font-semibold text-red-400">{errors.name.message}</p>
              )}
            </div>
            ...
            {/* Role selection */}
            <div className="space-y-2">
              <label htmlFor="role" className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                User Role
              </label>
              <div className="relative rounded-xl shadow-sm">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
                ...
                <select
                  id="role"
                  className="block w-full rounded-xl border bg-slate-950/60 py-3 pl-11 pr-4 text-sm text-white focus:outline-none focus:ring-2 focus:ring-primary-500/50 focus:border-transparent transition-all duration-200 border-slate-800 appearance-none cursor-pointer"
                  {...registerField('role')}
                >
                  <option value="CA" className="bg-slate-950 text-white text-sm">CA / Auditor (Chartered Accountant)</option>
                  <option value="Client" className="bg-slate-950 text-white text-sm">Taxpayer / Client</option>
                </select>
